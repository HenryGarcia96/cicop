...
if(($header$$2$$.attr("filter")==="false"?"":$header$$2$$.text()).length>1){$td$$=$$$$1$$("<td/>");var $filter$$=$$$$1$$($getFilterStr$$($i$$6$$,$header$$2$$));$filter$$.width('100%');$td$$.append($filter$$)}else $td$$=$$$$1$$("<td>&nbsp;</td>");$tr$$.append($td$$)}$grid$$.find("thead").append($tr$$)}function $getFilterStr$$($colIdx$$,$header$$3$$){var $filterType$$=$header$$3$$.attr("filter-type");$filterType$$||($filterType$$="text");switch($filterType$$){case "text":return"<input type='text' id='filter_"+
